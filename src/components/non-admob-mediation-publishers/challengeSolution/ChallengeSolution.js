...
import {
  ChallengesList,
  SolutionList,
} from "@/utils/mediation-publishers.utils";
    ...
    <Wrapper>
      <Container>
        <Box>
          ...
          <Box display="flex" flexWrap="wrap" justifyContent={{base:'center',  md: "center",lg: "space-around" }} gap='3%'>
            {ChallengesList.map((challenge, id) => {
              return (
                <StyleBox key={id} className="challengeSolution">
                  <Box key={id} padding="2%">
                    ...
                    <Center>
                      <Text width="120px" fontSize={{ base: '12px', md: '14px' }} textAlign="center">
                        {challenge.para}
                      </Text>
                    </Center>
                  </Box>
