            ...
            return (
              <Box key={id} width={{ base: "50%", md: "40%" }} marginY="2%">
                <StyleBox className="feature">
                  <center>
                    <chakra.svg as={Image} src={feature.image} alt={'feature'} w={{ base: '120px', md: '150px' }} />
                    <Text  as='h1'  fontSize={{ base: '15px', md: '16px',lg:'18px' }} wordBreak='keep-all' >
                      {feature.title}
                    </Text>
                      <Text width="80%" fontSize={{ base: '12px', md: '14px' }} wordBreak='keep-all'>{feature.paragraph}</Text>
                  </center>
                </StyleBox>
              </Box>
            );
